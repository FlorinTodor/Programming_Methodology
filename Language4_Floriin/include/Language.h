...
private:
  ...
  */
    ...
    void deallocate();
    /**
     * @brief Reserva memoria din�mica
     * @param i Tama�o para memoria din�mica
     * @return devuelve la direcci�n de memoria de donde comienza
     */
    friend BigramFreq * reservarmemoria(int i);

    /**
     * @brief Funcion que se basa en copiar los datos de other, dicha funci�n se llama en el operador de asignacion
