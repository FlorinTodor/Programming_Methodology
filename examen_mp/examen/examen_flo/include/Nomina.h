...
class Nomina{
    ...
    public:
         ...
         * @param sn
         */
        Nomina(Empleados &emp, const double sb, const double sn);
         ...
         * @param sb
         */
        void setSalarioBruto(const double sb);
        ...
        void setSalarioNeto(const double sn);
        ...
        void setEmpleadoNomina(const Empleados & emp);
